                ...
                <div className="container">
                    <div className="row row align-items-center">
                        <div className="col-lg-5 offset-lg-1 order-lg-1">
                            <img src="https://www.markuptag.com/images/web-development-vector.png" className="img-fluid" alt="Web Development"></img>
                        </div>
                        <div className="col-lg-6">
                            ...
                            <a href="#" className="btn btn-outline-secondary btn-lg border">Hire us</a>
                        </div>
                    </div>
                </div>
            </section>
